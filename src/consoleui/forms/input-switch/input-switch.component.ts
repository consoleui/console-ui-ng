import {
  NgModule, Component, ElementRef, AfterViewInit, AfterViewChecked, OnChanges,
  Input, forwardRef, EventEmitter, Output
} from '@angular/core';
...
export class InputSwitchComponent implements ControlValueAccessor, AfterViewInit, AfterViewChecked {
  ...
  render() {
    ...
    let labelWidth = containerWidth - handleWidth - spanPadding - handleMargins;
